...
//   // std::cout << "backpropM(...) started" << std::endl;
//   // std::cout << "max. # iters: " << maxNumOfIters << std::endl;
//   ///////////////////////////////////////////////////
//   double nue = -_nue;
...
//                      std::minus<double>());
//       double errCNorm =
//           sqrt(std::inner_product(errC.begin(), errC.end(), errC.begin(),
//           0.0));
//       // std::cout << errCNorm << " " << tol << " " << errTolCnt <<
//       std::endl; if (errCNorm > tol) {  // changed from 0.01
//         errTolCnt = 0;
//       } else {
//         errTolCnt++;
//       }
...
//   }      // iter
//   ///////////////////////////////////////////////////
//   // std::cout << "backpropM(...) max. # iters reached" << std::endl;
//   return -2;
// }  // backprop
//
...
//   }      // iter
//   ///////////////////////////////////////////////////
//   // std::cout << "backprop(...) max. # iters reached" << std::endl;
//   return -2;
// }  // backprop
//
...
//
// auto backpropNueABC(py::array_t<double> _Wa, py::array_t<double> _Wb,
//                     py::array_t<double> _Wc, int maxNumOfIters, double tol,
//                     double _nueA, double _nueB, double _nueC) {
//   // std::cout << "backprop(...) started" << std::endl;
//   // std::cout << "max. # iters: " << maxNumOfIters << std::endl;
//   ///////////////////////////////////////////////////
//   double nueA = -_nueA;
...
// }  // backprop
//
// auto backpropNueM(py::array_t<double> _Wa, py::array_t<double> _Wb,
//                   py::array_t<double> _Wc, py::array_t<double> _Ma,
//                   py::array_t<double> _Mb, py::array_t<double> _Mc,
...
// auto backpropNueABC2(py::array_t<double> _Wa, py::array_t<double> _Wb,
//                      py::array_t<double> _Wc, int maxNumOfIters, double tol,
//                      double _nueA, double _nueB, double _nueC, double jumpFac,
//                      int windowSize) {
//   // std::cout << "backprop(...) started" << std::endl;
//   // std::cout << "max. # iters: " << maxNumOfIters << std::endl;
//   double nueA = -_nueA;
...
//           deltaWa[i * nn + j] = nueA * errCStar[i] * bWaveStar[i] * a[j];
//           deltaWb[i * nn + j] = nueB * errCStar[i] * aWaveStar[i] * b[j];
//           // if (isnan(deltaWa[i * nn + j]) || isnan(deltaWb[i * nn + j])) {
//           //   return -1;
//           // }
//           Wa[i * nn + j] += deltaWa[i * nn + j];  // update
//           Wb[i * nn + j] += deltaWb[i * nn + j];  // update
...
//   }          // iter
//   // std::cout << "backprop(...) max. # iters reached" << std::endl;
//   return -2;  // max. number of iters
// }  // backprop
//
// auto backpropRND(py::array_t<double> _Wa, py::array_t<double> _Wb,
//                  py::array_t<double> _Wc, int maxNumOfIters, double _nue,
//                  double tol, int id) {
//   // std::cout << "backprop(...) started" << std::endl;
//   // std::cout << "max. # iters: " << maxNumOfIters << std::endl;
...
PYBIND11_MODULE(backprop, m) {
  ...
  m.def("backpropNueABC", backpropNueABC);
  m.def("backpropNueM", backpropNueM);
  m.def("backpropNueM2", backpropNueM2);
  m.def("backpropNueABC2", backpropNueABC2);
  m.def("backpropRND", backpropRND);
